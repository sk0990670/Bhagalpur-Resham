          ...
          <div className="border border-outline p-8 md:p-12 relative h-full w-full bg-surface-container-lowest">
            ...
            <form className="space-y-8" onSubmit={handleLogin}>
              <div className="relative">
                <input 
                  className="block w-full border-0 border-b border-primary bg-transparent py-2.5 px-0 text-on-surface focus:ring-0 focus:border-primary peer transition-colors" 
                  id="email" 
                  name="email" 
                  placeholder=" " 
                  required 
                ...
                />
                <label 
                  className="absolute text-sm text-on-surface-variant duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-primary peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 font-label-caps text-label-caps uppercase" 
                  htmlFor="email"
                >
                  Email Address
                </label>
