...
import silkMarkTagAsset from '../../../assets/silk_mark_tag.png';
  ...
  return (
    <main className="flex-grow pt-12 pb-section-gap px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto w-full relative">
      ...
      <section className="mb-16 text-center">
        <h1 className="font-display-lg-mobile md:font-display-lg text-display-lg-mobile md:text-display-lg text-primary mb-6">Silk Mark Certification</h1>
        <p className="font-story-serif text-story-serif text-on-surface-variant max-w-2xl mx-auto">
          Our commitment to 100% pure, authentic natural silk.
        </p>
        
        {/* Motif Divider */}
        <div className="flex justify-center items-center mt-8 space-x-4">
          <div className="h-px w-16 bg-secondary-fixed-dim"></div>
          <span className="material-symbols-outlined text-secondary-fixed-dim text-sm" style={{ fontVariationSettings: "'FILL' 1" }}>verified</span>
          <div className="h-px w-16 bg-secondary-fixed-dim"></div>
        </div>
      </section>
      ...
      <section className="flex flex-col md:flex-row gap-12 lg:gap-24 items-center py-12">
        <div className="w-full md:w-1/2 flex flex-col items-start order-2 md:order-1">
          <span className="font-label-caps text-label-caps text-primary tracking-widest mb-4">Purity & Trust</span>
          <h2 className="font-display-lg text-headline-xl text-on-surface mb-6">The Mark of Authenticity</h2>
          <p className="font-body-lg text-body-lg text-on-surface-variant mb-6 leading-relaxed">
            The Silk Mark is a certification mark in India for silk textiles. It serves as a guarantee that the product you are purchasing is made from 100% pure, natural silk, protecting consumers from counterfeit and blended fabrics.
          </p>
          <p className="font-body-md text-body-md text-on-surface-variant mb-8 leading-relaxed">
            At Bhagalpur Resham, we take immense pride in our heritage of authentic silk weaving. Every piece in our collection is backed by the Silk Mark certification, ensuring that the legacy of Bhagalpuri Tussar is preserved in its truest, purest form. When you drape our silk, you wear a promise of quality, sustainability, and unparalleled craftsmanship.
          </p>
