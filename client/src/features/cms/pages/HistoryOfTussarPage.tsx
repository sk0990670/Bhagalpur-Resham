...
import tussarSilkWeavingAsset from '../../../assets/tussar_silk_weaving.png';


const HistoryOfTussar = () => {
  return (
    <main className="flex-grow pt-12 pb-section-gap px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto w-full relative">
      ...
      <section className="mb-16 text-center">
        <h1 className="font-display-lg-mobile md:font-display-lg text-display-lg-mobile md:text-display-lg text-primary mb-6">The History of Tussar</h1>
        <p className="font-story-serif text-story-serif text-on-surface-variant max-w-2xl mx-auto">
          A journey through time, unraveling the origins and enduring legacy of wild silk.
        </p>
      ...
      <section className="flex flex-col md:flex-row gap-12 lg:gap-24 items-center py-12">
        <div className="w-full md:w-1/2 flex flex-col items-start order-2 md:order-1">
          <span className="font-label-caps text-label-caps text-primary tracking-widest mb-4">Origins of Wild Silk</span>
          <h2 className="font-display-lg text-headline-xl text-on-surface mb-6">The Wild Silk</h2>
          <p className="font-body-lg text-body-lg text-on-surface-variant mb-6 leading-relaxed">
            Tussar silk, often referred to as 'Wild Silk', is derived from the wide-winged moth that is yellowish-brown in color. The history of Tussar silk dates back to ancient times, deeply rooted in the traditions of Indian weaving.
          </p>
          <p className="font-body-md text-body-md text-on-surface-variant mb-8 leading-relaxed">
            Unlike cultivated silk, Tussar has a distinct, rich texture and a natural golden sheen. Its production is a testament to the harmony between nature and artisanship, relying on the careful rearing of silkworms in the wild forests, particularly in the central and eastern regions of India.
          </p>
...
export default HistoryOfTussar;
